# Deploy a Python (Flask) web app with Relational Databases (e.g., PostgreSQL)

This is a Python web app using the Flask framework and a relational database instance (e.g., PostgreSQL). The fork repository describes how Flask works with Relational Databases, which can also be tested and serviced on production using a public cloud like Azure. The Flask app is hosted in a fully managed Azure App Service. This app is designed to be be run locally and then deployed to Azure. For more information on how to use this web app on Azure, see the tutorial [*Deploy a Python (Django or Flask) web app with PostgreSQL in Azure*](https://docs.microsoft.com/en-us/azure/app-service/tutorial-python-postgresql-app).

A Django sample application with Azure is also available for the article at https://github.com/Azure-Samples/msdocs-django-postgresql-sample-app.
